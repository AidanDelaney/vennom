...
public class APEntry extends Frame implements ActionListener {
	...
	// only want one of these in existance at a time
	private static APEntry singleAPEntry = null;
	
	/** Node list must have at least one element */
	public APEntry(APCirclePanel circlePanel) {

		super("Enter Specification");
...
// cancel button has the focus, redirect to the cancel 
		...
		Graph g = as.generateAugmentedIntersectionGraph();
		if(g != null) {
