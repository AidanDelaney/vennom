...
public class APGeneralEntry extends Frame implements ActionListener {
	...
	private static APGeneralEntry singleAPEntry = null;
	
	/** Node list must have at least one element */
	public APGeneralEntry(APCirclePanel circlePanel) {

		super("Enter General AP Specification");
