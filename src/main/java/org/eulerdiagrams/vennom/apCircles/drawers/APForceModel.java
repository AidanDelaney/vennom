...
/** Trivial constructor. */
	public APForceModel(int key, String s) {
		super(key,s);
	}
/** Constructor. */
	public APForceModel(int key, String s, boolean inRandomize) {
		super(key,s);
		randomize = inRandomize;
	}
/** Full constructor. */
	public APForceModel(int key, String s, int mnemomic, boolean inRandomize) {
