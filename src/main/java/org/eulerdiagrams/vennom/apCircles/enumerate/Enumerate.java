...
//		AbstractDiagram ad = new AbstractDiagram("b ac ad abc acd bcd abcd");
//		ad.normalize();
...
//	 			System.out.print((System.currentTimeMillis()-startMillis)/1000.0+" "+bruteForceTimeTotal/1000.0+" ");
	 			System.out.println(ad);
/*				PiercingDiagram pd = new PiercingDiagram(ad.toString());			
				if(pd.getIsPiercingDiagram()){
					idx++;
					System.out.println(idx+ " " + ad +" "); // this outputs each unique diagram
				}
*/			}
		}
		double totalSeconds = (System.currentTimeMillis()-startMillis)/1000.0;
