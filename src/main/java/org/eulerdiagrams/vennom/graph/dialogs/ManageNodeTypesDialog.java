...
/** Node list must have at least one element */
	public ManageNodeTypesDialog(APCirclePanel graphPanel) {
		super(graphPanel.getContainerFrame(),"Manage Node Types",true);
	...
	public void editNodeType() {
		...
		new EditNodeTypeDialog(this,gp,theType,false,"Editing Type "+theType.getLabel());
	...
	public void newNodeType() {
		...
		if(typeList.isSelectionEmpty()) {
			new EditNodeTypeDialog(this,gp,null,true,"New Node Type");
		} else {
			int index = typeList.getSelectedIndex();
			NodeType theType = (NodeType)allTypes.get(index);
			new EditNodeTypeDialog(this,gp,theType,true,"New Node Type");
		}
