...
import uk.ac.kent.pjr.graph.comparators.EdgeTypePriorityComparator;
...
/** Edge list must have at least one element */
	public ManageEdgeTypesDialog(APCirclePanel graphPanel) {
		super(graphPanel.getContainerFrame(),"Manage Edge Types",true);
	...
	protected void setupList(JPanel panel) {
		...
		promoteButton.setPreferredSize(APCirclePanel.LARGEBUTTONSIZE);
		...
		demoteButton.setPreferredSize(APCirclePanel.LARGEBUTTONSIZE);
		...
		editButton.setPreferredSize(APCirclePanel.BUTTONSIZE);
		...
		newButton.setPreferredSize(APCirclePanel.BUTTONSIZE);
	...
	public void editEdgeType() {
		...
		new EditEdgeTypeDialog(this,gp,theType,false,"Editing Type "+theType.getLabel());
	...
	public void newEdgeType() {
		if(typeList.isSelectionEmpty()) {
			new EditEdgeTypeDialog(this,gp,null,true,"New Edge Type");
		} else {
			int index = typeList.getSelectedIndex();
			EdgeType theType = (EdgeType)allTypes.get(index);
			new EditEdgeTypeDialog(this,gp,theType,true,"New Edge Type");
		}
